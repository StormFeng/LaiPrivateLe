...
import com.lailem.app.jsonbean.activegroup.GroupActiveListBean.GroupActive;
...
public class GroupActiveTpl extends BaseTpl<GroupActive> {
    @Bind(R.id.avatar)
    ImageView avatar_iv;
    @Bind(R.id.name)
    TextView name_tv;
    ...
    private GroupActive bean;

    public GroupActiveTpl(Context context) {
        super(context);
    }
    ...
    @Override
    public void setBean(GroupActive bean, int position) {
        this.bean = bean;
        ...
        activeJoinCount_tv.setBackgroundColor(Color.parseColor(bean.getTypeColor()));
