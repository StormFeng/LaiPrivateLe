...
public class NotificationGroupNoticeTpl extends BaseTpl<Message> {
    @Bind(R.id.state)
    TextView stateTV;
    @Bind(R.id.title)
    TextView titleTV;
    ...
    public NotificationGroupNoticeTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_notification_group_notice;
    }
    ...
    public void setBean(Message bean, int position) {
        ...
        MsgGNotice msgObj = bean.getMsgObj();
        titleTV.setText(msgObj.getTopic());
        contentTV.setText(msgObj.getDetail());
