...
import com.lailem.app.share_ex.model.ShareContent;
...
public class WeiboShareManager implements IShareManager {
    ...
    public static final String REDIRECT_URL = JniSharedLibraryWrapper.weiboRedirectUrl();
    ...
    private void allInOneShare(final Context context, SendMultiMessageToWeiboRequest request) {
        ...
        mSinaAPI.sendRequest((Activity) context, request, authInfo, token, new WeiboAuthListener() {
            ...
            public void onWeiboException(WeiboException arg0) {
                Toast.makeText(context, mContext.getString(R.string.share_failed), Toast.LENGTH_SHORT).show();
            }
            ...
            public void onComplete(Bundle bundle) {
                ...
                Toast.makeText(context, mContext.getString(R.string.share_success), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancel() {
//                Toast.makeText(context, mContext.getString(R.string.share_cancel), Toast.LENGTH_SHORT).show();
