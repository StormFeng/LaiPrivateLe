...
public class DataBankMapLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new DataBankMapLoadViewHelper();
    }

    public static class DataBankMapLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_data_bank_map);
