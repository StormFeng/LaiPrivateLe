...
public class GroupNotificationLoadViewFactory implements ILoadViewFactory {
	...
	public ILoadView madeLoadView() {
		return new MeFavoriteLoadViewHelper();
	}

	public static class MeFavoriteLoadViewHelper implements ILoadView {
		...
		public void showEmpty() {
			View layout = helper.inflate(R.layout.load_empty_group_notification);
