...
public class ConversationLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new ChatLoadViewHelper();
    }

    public static class ChatLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_conversation);
