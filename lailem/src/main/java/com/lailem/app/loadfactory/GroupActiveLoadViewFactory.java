...
public class GroupActiveLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new GroupActiveLoadViewHelper();
    }

    public static class GroupActiveLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_group_active);
