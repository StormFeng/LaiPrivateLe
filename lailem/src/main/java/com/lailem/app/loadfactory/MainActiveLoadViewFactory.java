...
public class MainActiveLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new MainActiveLoadViewHelper();
    }

    public static class MainActiveLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_main_active);
