...
public class MeDynamicLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new MeDynamicLoadViewHelper();
    }

    public static class MeDynamicLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_me_dynamic);
