...
public class DynamicActiveLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new DynamicActiveLoadViewHelper();
    }

    public static class DynamicActiveLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_dynamic_active);
            layout.findViewById(R.id.see).setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    UIHelper.showWebView(activity, WebViewActivity.TYPE_ACTI_LAILE);
                }
            });
            layout.findViewById(R.id.add).setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    UIHelper.showCreateType(activity, 0);
                }
            });
