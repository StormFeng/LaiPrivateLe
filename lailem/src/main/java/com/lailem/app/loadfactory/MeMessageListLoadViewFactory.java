...
public class MeMessageListLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new MeMessageListLoadViewHelper();
    }

    public static class MeMessageListLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_me_message);
