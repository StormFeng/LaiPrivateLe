...
public class DynamicGroupLoadViewFactory implements ILoadViewFactory {
	...
	public ILoadView madeLoadView() {
		return new DynamicGroupLoadViewHelper();
	}

	public static class DynamicGroupLoadViewHelper implements ILoadView {
		...
		public void showEmpty() {
			View layout = helper.inflate(R.layout.load_empty_dynamic_group);
			layout.findViewById(R.id.see).setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					UIHelper.showWebView(activity, WebViewActivity.TYPE_GROUP_LAILE);
				}
			});
