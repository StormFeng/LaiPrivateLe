...
public class DataBankVoiceLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new DataBankVoiceLoadViewHelper();
    }

    public static class DataBankVoiceLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_data_bank_voice);
