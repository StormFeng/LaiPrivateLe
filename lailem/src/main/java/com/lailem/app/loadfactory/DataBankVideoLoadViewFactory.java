...
public class DataBankVideoLoadViewFactory implements ILoadViewFactory {
    ...
    public ILoadView madeLoadView() {
        return new DataBankVideoLoadViewHelper();
    }

    public static class DataBankVideoLoadViewHelper implements ILoadView {
        ...
        public void showEmpty() {
            View layout = helper.inflate(R.layout.load_empty_data_bank_video);
