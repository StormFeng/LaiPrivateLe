...
public class EncryptionUtil {
	...
	public static String getEncryptionStr() {
		String result = encryptString(JniSharedLibraryWrapper.ckValue() + System.currentTimeMillis() + "");
	 ...
	 * @throws Exception
	 */
	private static byte[] symmetricEncrypt(byte[] byteSource, String sKey) throws Exception {
