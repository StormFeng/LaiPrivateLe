...
import com.lailem.app.ui.databank.DataBankVideoFragment;
import com.lailem.app.utils.Const;

import java.util.ArrayList;

public class DataBankVideoDataSource extends BaseListDataSource<Object> {

    private final String groupId;

    public DataBankVideoDataSource(Context context, String groupId) {
        super(context);
    ...
    protected ArrayList<Object> load(int page) throws Exception {
        ...
        GroupDatabaseBean list = (GroupDatabaseBean) ApiClient.getApi().getGroupDatabase(groupId, AppContext.PAGE_SIZE + "", page + "", Const.DATABASE_TYPE_VIDEO);
            ...
            for (GroupDatabaseBean.DataBase dataBase : list.getDatabase()) {
                ...
                for (int i = 0; i < dataBase.getDataList().size(); i++) {
                    if (i % 3 == 0) {
                        ...
                        models.add(new ObjectWrapper(item, DataBankVideoFragment.TPL_VIDEO));
                    }
