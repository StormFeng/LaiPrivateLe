...
import com.lailem.app.widget.astickyheader.PinnedSectionListView;
import com.lailem.app.widget.pulltorefresh.PullToRefreshSectionListView;
...
public abstract class BaseSectionListActivity<Model> extends BaseActivity implements OnItemClickListener, OnStateChangeListener<ArrayList<Model>>, OnItemLongClickListener {

	protected ListViewHelper<Model> listViewHelper;

	protected PullToRefreshSectionListView refreshListView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (getLayoutId() == -1) {
			setContentView(R.layout.c_list_section_activity);
		} else {
			setContentView(getLayoutId());
		}
		refreshListView = (PullToRefreshSectionListView) findViewById(R.id.pullToRefreshListView);
