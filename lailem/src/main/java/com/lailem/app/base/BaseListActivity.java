 ...
 */
public abstract class BaseListActivity<Model> extends BaseActivity implements OnItemClickListener, OnStateChangeListener<ArrayList<Model>>, OnItemLongClickListener {
