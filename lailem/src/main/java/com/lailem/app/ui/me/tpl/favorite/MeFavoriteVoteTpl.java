...
public class MeFavoriteVoteTpl extends BaseTpl<PublishInfo> implements OnVotedCallback {

    @Bind(R.id.dynamicVote)
    DynamicVoteView dynamicVoteView;
    private PublishInfo bean;

    public MeFavoriteVoteTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_me_favorite_vote;
    }
