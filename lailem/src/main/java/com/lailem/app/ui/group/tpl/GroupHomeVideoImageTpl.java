 ...
 */
public class GroupHomeVideoImageTpl extends BaseTpl<ObjectWrapper> {
    @Bind(R.id.fl)
    FlowLayout fl;
    ...
    public GroupHomeVideoImageTpl(Context context) {
        super(context);
    }
    ...
    protected void initView() {
        ...
        LinearLayout.LayoutParams params = (LayoutParams) fl.getLayoutParams();
