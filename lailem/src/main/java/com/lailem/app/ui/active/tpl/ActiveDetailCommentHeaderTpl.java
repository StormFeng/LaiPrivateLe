 ...
 */
public class ActiveDetailCommentHeaderTpl extends BaseTpl<Object> implements AddCommentBarDialog.OnSendClickListener {
    ...
    public ActiveDetailCommentHeaderTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_active_detail_comment_header;
    }
    ...
    private void addNewComment(String commentId) {
        ...
        data.add(position + 1, newComment);
    }
