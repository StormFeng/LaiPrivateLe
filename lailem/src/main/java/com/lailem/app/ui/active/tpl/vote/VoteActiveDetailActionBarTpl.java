...
public class VoteActiveDetailActionBarTpl extends BaseTpl<Object> implements OnSendClickListener {
    ...
    public VoteActiveDetailActionBarTpl(Context context) {
        super(context);
    }
...
//        String content = activeInfo.getVoteInfo().getDesc();
//        String dataUrl = Const.VOTE_ACTIVE_PATTERN + activeInfo.getId();
//        String imageUrl = ApiClient.getFileUrl(activeInfo.getbPicName());
//        String smsContent = activeInfo.getName() + "来了，" + activeInfo.getVoteInfo().getDesc() + "，活动详情： " + dataUrl;
//        String emailContent = activeInfo.getName() + "来了，" + activeInfo.getVoteInfo().getDesc() + "，活动详情： " + dataUrl;
