 ...
 */
public class ActiveDetailForCreatorTpl extends BaseTpl<ObjectWrapper> {
    @Bind(R.id.avatar)
    ImageView avatar_iv;
    ...
    public ActiveDetailForCreatorTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_active_detail_for_creator;
    }
    ...
    public void addNotice() {
        UIHelper.showCreateNotice(_activity, bean.getId());
    }

    @OnClick(R.id.addSchedule)
    public void addSchedule() {
        UIHelper.showCreateDyanmic(_activity, bean.getId(), CreateDynamicActivity.TYPE_SCHEDULE);
    ...
    public boolean newAddDynamic() {
        UIHelper.showNewCreateDynamic(_activity, bean.getId());
        return false;
    }
}
