...
public class DynamicDetailAvatarTpl extends BaseTpl<PublisherInfo> {
    @Bind(R.id.avatar)
    ImageView avatar_iv;
    @Bind(R.id.name)
    TextView name_tv;
    ...
    public DynamicDetailAvatarTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_dynamic_detail_avatar;
    }
