...
public class MemberInfoForChatActivity extends BaseActivity implements OnToggleChanged {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_info_for_chat);
    ...
    private void initView() {
        topbar.setTitle("聊天信息").setBack("返回", R.drawable.ic_topbar_back, UIHelper.finish(this));
