 ...
 */
public class GroupHomeForCreatorTpl extends BaseTpl<ObjectWrapper> {
    @Bind(R.id.avatar)
    ImageView avatar_iv;
    @Bind(R.id.groupName)
    ...
    public GroupHomeForCreatorTpl(Context context) {
        super(context);
    }

    @Override
    protected int getLayoutId() {
        return R.layout.item_group_home_for_creator;
    }
    ...
    public void clickGroupInfo() {
        ...
        UIHelper.showGroupInfoForCreator(_activity, bean.getId());
    }
