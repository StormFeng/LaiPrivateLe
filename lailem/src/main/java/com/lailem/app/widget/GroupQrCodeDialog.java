...
public class GroupQrCodeDialog extends Dialog {
    ...
    private String groupName, groupNum, groupId, address;
    private Bitmap qrCodeBitmap;

    public GroupQrCodeDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init(context);
    }

    public GroupQrCodeDialog(Context context, int theme) {
        super(context, theme);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        contentView = View.inflate(context, R.layout.dialog_group_qrcode, null);
    ...
    public void setGroupInfo(String groupName, String groupNum, String groupId, String address) {
        ...
        groupNum_tv.setText("来了群号：" + groupNum);
        address_tv.setText(address);

        String url = Const.GROUP_PATTERN + groupId;
        try {
