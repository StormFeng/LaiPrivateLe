 ...
 * @since 2013-8-15
 */
public class PullZoomRefresListView extends PullToRefreshBase<ListView> {
	 ...
	 *            context
	 */
	public PullZoomRefresListView(Context context) {
		this(context, null);
	}
	 ...
	 *            attrs
	 */
	public PullZoomRefresListView(Context context, AttributeSet attrs) {
	 ...
	 *            defStyle
	 */
	public PullZoomRefresListView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected ListView createRefreshableView(Context context, AttributeSet attrs) {
		PullToZoomListView listView = new PullToZoomListView(context);
		mListView = listView;
