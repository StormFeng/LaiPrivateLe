...
public class ListViewHelper<Model> implements OnRefreshListener<ListView>, IViewHelper {
    ...
    public void refresh() {
        ...
        asyncTask = new AsyncTask<Void, Void, ArrayList<Model>>() {
            ...
            protected void onPostExecute(ArrayList<Model> result) {
                ...
                if (dataSource.isPullDownLoadMore()) {
                    if (result != null) {
                        plv.getRefreshableView().setSelectionFromTop(result.size(), (int) TDevice.dpToPixel(60));
                    }
                }
            }
